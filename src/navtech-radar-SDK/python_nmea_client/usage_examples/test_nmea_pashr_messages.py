...
parser = argparse.ArgumentParser(
    description="Tests the NMEA PASHR message from a NMEA device"
)

parser.add_argument(
    "-i", "--ip_address",
    nargs='?', const = "192.168.0.1",
    help="The network address of the NMEA device"
)
...
parser.add_argument(
    ...
    nargs='?', type=int,
    const=9095,
    help="The NMEA device's network port"
)
...
client = nmea_client.NmeaClient(args.ip_address, args.port)
