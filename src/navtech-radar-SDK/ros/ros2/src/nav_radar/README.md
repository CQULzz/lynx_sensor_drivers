...
Each pixel value represents the raw 8 bit return power value from the radar, represented in half dB steps. So for example, a pixel value of 50 represents a radar return power value of 25dB.
