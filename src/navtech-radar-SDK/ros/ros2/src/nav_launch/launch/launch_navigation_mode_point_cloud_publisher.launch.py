...
def generate_launch_description():
  ...
  executable_name = "navigation_mode_point_cloud_publisher"
  config_file_name = "navigation_mode_point_cloud_publisher.yaml"
  rviz_file_name = "navigation_mode_point_cloud_view.rviz"
