...
def generate_launch_description():
  ...
  executable_name = "colossus_subscriber_laser_scan_publisher"
  config_file_name = "colossus_subscriber_laser_scan_publisher.yaml"
  rviz_file_name = "laser_scan_view.rviz"
