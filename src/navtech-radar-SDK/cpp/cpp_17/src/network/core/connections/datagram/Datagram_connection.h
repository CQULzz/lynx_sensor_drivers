...
template <Protocol protocol, Transport transport, TLS::Type tls>
    ...
    void Sender<protocol, transport, tls>::send(const Message_buffer& msg)
    {
        ...
        try {
            ...
            syslog.debug("Datagram sender [" + std::to_string(id) + "] client disconnected");

            disable();
            error_events->notify<Error::Event::tx_error>(id);
        }
        catch (std::system_error& ex) {
            syslog.debug("Datagram sender [" + std::to_string(id) + "] caught exception: " + ex.what());
    ...
    {
        syslog.debug("Datagram sender [" + std::to_string(id) + "] enabled.");
    ...
    void Sender<protocol, transport, tls>::disable()
    {
        ...
        syslog.debug("Datagram sender [" + std::to_string(id) + "] disabled.");
    }
    ...
    {
        syslog.debug("Datagram receiver [" + std::to_string(id) + "] starting...");
    ...
    {
        syslog.debug("Datagram receiver [" + std::to_string(id) + "] stopping...");
    ...
    template <Protocol protocol, Transport transport, TLS::Type tls>
    Utility::Active::Task_state Receiver<protocol, transport, tls>::run()
    {
        if (!enabled) {
        ...
        try {
            ...
            syslog.debug("Datagram receiver [" + std::to_string(id) + "] client disconnected");
            ...
            syslog.debug("Datagram receiver [" + std::to_string(id) + "] caught exception: " + ex.what());
    ...
    {
        syslog.debug("Datagram receiver [" + std::to_string(id) + "] enabled");
    ...
    void Receiver<protocol, transport, tls>::disable() 
    {
        ...
        syslog.debug("Datagram receiver [" + std::to_string(id) + "] disabled");
    }
    ...
    {
        syslog.debug("Datagram receiver [" + std::to_string(id) + "] notify rx error");
    ...
    void Connection<protocol, transport, tls>::open()
    {
        ...
        syslog.debug("Datagram connection [" + std::to_string(ident) + "] open.");
    }
    ...
    void Connection<protocol, transport, tls>::close()
    {
        ...
        syslog.debug(
            "Datagram connection [" + std::to_string(ident) + "] closed. "
    ...
    void Connection<protocol, transport, tls>::on_send_error(const ID_Ty& session_in_error)
    {
        ...
        //
        syslog.debug("Datagram connection [" + std::to_string(ident) + "] tx error. Requesting termination.");
    ...
    void Connection<protocol, transport, tls>::on_receive_error(const ID_Ty& session_in_error)
    {
        ...
        // should terminate this connection.
        //
        syslog.debug("Datagram connection [" + std::to_string(ident) + "] rx error. Requesting termination.");
