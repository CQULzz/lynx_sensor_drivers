...
namespace Navtech::Networking::Secure {
    ...
    {
        syslog.debug("Secure sender [" + std::to_string(id) + "] starting...");
    ...
    {
        syslog.debug("Secure sender [" + std::to_string(id) + "] stopping...");
    ...
    void Sender<protocol, transport, tls>::send(const Sender<protocol, transport, tls>::Message_buffer_Ty& msg)
    {
        ...
        try {
            ...
            syslog.debug("Secure sender [" + std::to_string(id) + "] caught exception: " + ex.what());
    ...
    {
        syslog.debug("Secure sender [" + std::to_string(id) + "] enabled");
        enabled = true;
    }
    ...
    void Sender<protocol, transport, tls>::disable()
    {
        ...
        syslog.debug("Secure sender [" + std::to_string(id) + "] disabled");
    }
