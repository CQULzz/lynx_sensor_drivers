...
namespace Navtech::Networking {
    ...
    Byte_array_4 to_byte_array(float value)
    {
        Byte_array_4 buffer { };
    ...
    std::uint64_t to_uint64_host(std::uint64_t network_value)
    {
        uint64_uint32_map u { };
        u.as_int = network_value;
        u.as_array[0] = to_uint32_host(u.as_array[0]);
        u.as_array[1] = to_uint32_host(u.as_array[1]);
        std::swap(u.as_array[0], u.as_array[1]);
        return u.as_int;
    }


    std::uint64_t to_uint64_network(std::uint64_t network_value)
    {
        uint64_uint32_map u { };
        u.as_int = network_value;
        u.as_array[0] = to_uint32_network(u.as_array[0]);
